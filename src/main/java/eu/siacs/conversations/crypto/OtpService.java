...
public class OtpService  {
    ...
    protected File mKeyFile, mKeyFileOffset;
    ...
    public File getmKeyFile(){
     ...
     public void setKey(/*String KeyFilePath*/) throws IOException {
        ...
        String fileNameOffset=ConversationActivity.OtpKeyFilePaths+"/"+mJid+"offset.txt";
        this.mKeyFileOffset= new File( fileNameOffset );
        this.mKeyFile = new File(fileName );
        //check if file readable
        if (!this.mKeyFile.exists() ) {
            this.mKeyFile=null;
            //this.mKeyFileOffset=null;
           return;
        }
    ...
    public int getOffset(){
        try {
            RandomAccessFile i = new RandomAccessFile(this.mKeyFileOffset, "rw");
           // i.setLength(0);
            this.offset = i.readInt();
            i.close();
        }catch(EOFException exc){
            Log.d("OTPOffset"," offset file will be created ");
        }catch(Throwable exc){
            Log.d("OTPOffset","Cant read to offsetfile: "+exc.toString());
        }
    ...
    public void setOffset(int offset) {
        try {
            ...
            Log.d("OTPOffset","Cant write to offsetfile: "+exc.toString());
        }
    }
